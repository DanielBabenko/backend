...
let CANVAS = null;
const AXES_COLOR = '#fff'
const AREA_COLOR = '#4169E1';
let scale = 0.017;
...
//
let centerX = WIDTH / 2;  //в этом мест x=0 с точки зрения математических координат
let centerY = HEIGHT / 2;  //в этом мест y=0 с точки зрения математических координат
